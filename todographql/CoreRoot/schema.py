...
from core.tasks.schema import TaskQuery, TaskMutations, TaskSubTasksQuery, TaskSubscription
...
schema = graphene.Schema(query=Query, mutation=Mutation, subscription=TaskSubscription)
